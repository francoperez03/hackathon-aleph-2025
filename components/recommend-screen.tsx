  ...
  return (
    ...
    >
      ...
      <form className="mb-8 w-full max-w-xs" onSubmit={handleSubmit}>
        <div className="mb-6">
          <label className="mb-2 block text-xs font-medium text-[#666]">WALLET ADDRESS</label>
            ...
            >
              {confirmed ? (
                <div className="flex flex-col items-center justify-center py-6">
                  ...
                  <h3 className="text-xl font-bold text-[#333]">Recommendation Sent!</h3>
                  <p className="mt-2 text-center text-sm text-[#666]">Your invitation has been sent successfully</p>
                </div>
              ) : (
                <>
                  <div className="mb-4 flex items-center justify-center">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-[#333]">Confirm Recommendation</h3>
                      <p className="text-sm text-[#666]">This will use 1 invite credit</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <Button className="flex-1 bg-[#0088cc] text-white hover:bg-[#0077b3]" onClick={handleConfirm}>
                      Confirm
                    </Button>
                  </div>
                </>
