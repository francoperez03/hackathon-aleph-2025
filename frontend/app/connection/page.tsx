  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-xs flex flex-col items-center text-center mb-6">
        <h1 className="text-3xl font-bold text-gray-800">VPN Status</h1>
      ...
      <div className="flex flex-col items-center justify-center flex-grow w-full max-w-xs text-center">
        ...
        {vpnStatus === "active" && (
          ...
          >
            ...
            <h3 className="text-lg font-bold text-gray-800">VPN is Active</h3>
        ...
        {vpnStatus === "expired" && (
          ...
          >
            ...
            <h3 className="text-lg font-bold text-gray-800">VPN Expired</h3>
            <p className="text-sm text-[#666] mt-1">
